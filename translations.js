...
const translations = {
    en: {
        ...
        'features.search.desc': 'On Pro and above, ask the AI a question and get a cited answer from your own documents, with a link to the source it used.',
        ...
        'faq.a2': "Yes! Scandora's free plan includes unlimited scans, 10 AI credits a month (extraction, indexing and AI document chat), cloud integrations, and watermark-free exports. Paid plans are available now: Pro (€9.99/month or €89/year) adds a much larger monthly AI-credit allowance and priority support, and Business / DATEV (€24.99/month or €229/year) adds DATEV, lexoffice and sevDesk export designed for GoBD & DSGVO record-keeping. Prices are the final amounts charged via the App Store or Google Play.",
        ...
        'faq.a4': "Privacy is built into Scandora's design. Your documents never touch our servers — they sync straight to the cloud services and AI provider you choose. On Pro and above, if you opt in to AI document chat, an optional EU-resident search index (Frankfurt) stores derived text only — not your original files. Managed AI generation may be processed outside the EU (e.g. Google Gemini in the USA) under EU Standard Contractual Clauses and the EU–US Data Privacy Framework. You stay in control of your data.",
    ...
    de: {
        ...
        'features.search.desc': 'Ab Pro stellen Sie der KI eine Frage und erhalten eine belegte Antwort aus Ihren eigenen Dokumenten — mit Link zur verwendeten Quelle.',
