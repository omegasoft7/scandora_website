...
const translations = {
    en: {
        ...
        'faq.a4': "Privacy is built into Scandora's design. Your documents never touch our servers — they sync straight to the cloud services and AI provider you choose. If you opt in to AI document chat, an optional EU-resident search index (Frankfurt) stores derived text only — not your original files. Managed AI generation may be processed outside the EU (e.g. Google Gemini in the USA) under EU Standard Contractual Clauses and the EU–US Data Privacy Framework. You stay in control of your data.",
