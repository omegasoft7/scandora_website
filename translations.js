...
const translations = {
    en: {
        ...
        'faq.a2': "Yes! Scandora's free plan includes private, offline on-device search of your scans, unlimited scans, 10 AI credits a month (extraction, indexing and AI document chat), cloud integrations, and watermark-free exports. Paid plans are available now: Pro (€9.99/month or €89/year) adds a much larger monthly AI-credit allowance and priority support, and Business / DATEV (€24.99/month or €229/year) adds DATEV, lexoffice and sevDesk export designed for GoBD & DSGVO record-keeping. Prices are the final amounts charged via the App Store or Google Play.",
        ...
        'faq.a4': "Privacy is built into Scandora's design. Your documents stay on your device by default, and on-device search is private and works offline. On Pro and above, if you opt in to AI document chat, an optional EU-resident search index (Frankfurt) stores derived text only — not your original files. Managed AI generation may be processed outside the EU (e.g. Google Gemini in the USA) under EU Standard Contractual Clauses and the EU–US Data Privacy Framework. You stay in control of your data.",
    ...
    de: {
        ...
        'faq.a2': 'Ja! Der kostenlose Tarif von Scandora umfasst die private, offline funktionierende Suche Ihrer Scans auf dem Gerät, unbegrenzte Scans, 10 KI-Credits pro Monat (Extraktion, Indexierung und KI-Dokumenten-Chat), Cloud-Integrationen und Exporte ohne Wasserzeichen. Bezahlte Tarife sind jetzt verfügbar: Pro (9,99 €/Monat oder 89 €/Jahr) ergänzt ein deutlich größeres monatliches KI-Credit-Kontingent und Prioritäts-Support, und Business / DATEV (24,99 €/Monat oder 229 €/Jahr) ergänzt DATEV-, lexoffice- und sevDesk-Export für die GoBD- & DSGVO-Aufbewahrung. Die Preise sind die über App Store oder Google Play berechneten Endpreise.',
